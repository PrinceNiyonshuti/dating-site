            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Your Request</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <!-- Hotel Reservation Area -->
                        <?php
                            $sql5=" SELECT * FROM request,members WHERE request.receiver_id=members.member_id AND request.sender_id='$member_id' ";
                    ...
                    <div class="card">
                      <div class="card-header">
                         Request Sent on <strong><?php echo $created_date ?></strong> 
                      </div>
